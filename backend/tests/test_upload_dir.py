...
from backend.core.config import _DEFAULT_UPLOAD_FOLDER
...
def test_default_upload_dir_is_outside_repo():
    ...
    assert not os.path.abspath(_DEFAULT_UPLOAD_FOLDER).startswith(
        os.path.abspath(settings.PROJECT_ROOT) + os.sep
    )
